...
import { content } from "config/content/custom-scrollbar";
  ...
  return (
    ...
    >
      ...
      <div className="content-container">
        <p>
          You will also have to deactivate the scrollback of the html. The
          onScroll function detects the progress of the scroll related to the
          size of the body. Then, the useEffect just listens to that function
          when you scroll. The height of the fill depends on the progress state.
        </p>
      </div>
    </ArticleContainer>
  );
